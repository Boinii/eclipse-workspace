...
//		System.out.println("The actual attribute of the targetproperty is:- "+attributeofthetarget);
		...
		for(int arrayindex=0;arrayindex<Enquirty.size();arrayindex++) {
			String homepagelinksnaes=Enquirty.get(arrayindex).getText();
			System.out.println(arrayindex+"-"+homepagelinksnaes);
		}
