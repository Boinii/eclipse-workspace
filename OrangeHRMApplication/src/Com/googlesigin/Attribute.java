...
//signin.click();
String attributepropertyoftheactualpagehref=signin.getAttribute("href");
System.out.println("The attribute of the current page is :- "+attributepropertyoftheactualpagehref);
String attributepropertyofthetarget=signin.getAttribute("target");
System.out.println("The attribute of the target is :- "+attributepropertyofthetarget);
Driver.close();
	}
